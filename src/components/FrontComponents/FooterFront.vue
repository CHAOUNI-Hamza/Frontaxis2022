<template>
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      <div class="copyright">
        &copy; Copyright <strong><span>Axis Desing</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
        ...
        Designed by <a href="https://www.linkedin.com/in/hamza-chaouni-bb26831a9/">Hamza CHAOUNI</a>
      </div>
    </div>
  </footer><!-- End Footer -->
  </div>
